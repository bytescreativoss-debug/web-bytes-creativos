  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-24 min-h-screen text-center">
      <div className="flex justify-center gap-8 mb-12">
        <div className="bg-[#161616] border border-white/5 rounded-2xl p-6 hover:border-[#C8F000] transition-all text-center">
          ...
          <a href="https://wa.me/5491123456789" className="text-[#C8F000] hover:underline">Contactanos</a>
        </div>
        <div className="bg-[#161616] border border-white/5 rounded-2xl p-6 hover:border-[#C8F000] transition-all text-center">
          ...
          <h4 className="text-white font-bold mb-2">Correo</h4>
          <a href="mailto:contacto@bytescreativos.com" className="text-[#C8F000] hover:underline">Enviar Email</a>
        </div>
      </div>
        ...
        <div className="fixed bottom-10 right-10 z-[9999] flex flex-col items-end gap-4">
          ...
          <div className="contact-bubbles flex flex-col gap-2 mb-4" style={{ perspective: '1000px', opacity: isContactOpen ? 1 : 0, pointerEvents: isContactOpen ? 'auto' : 'none', transition: 'opacity 0.3s ease' }}>
              <div className="relative group" style={isContactOpen ? { transform: 'rotateX(0deg) scale(1)', transition: 'transform 0.5s ease 0s' } : { transform: 'rotateX(90deg) scale(0)', transition: 'transform 0.5s ease 0s' }}>
                <span className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-full mr-2 bg-[#161616] text-[#C8F000] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Chatbot</span>
                <button onClick={() => { setIsChatOpen(true); setIsContactOpen(false); }} className="w-12 h-12 bg-[#C8F000] rounded-full flex items-center justify-center text-black shadow-xl hover:scale-110 transition-all">
              ...
              <div className="relative group" style={isContactOpen ? { transform: 'rotateX(0deg) scale(1)', transition: 'transform 0.5s ease 0.1s' } : { transform: 'rotateX(90deg) scale(0)', transition: 'transform 0.5s ease 0.1s' }}>
                <span className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-full mr-2 bg-[#161616] text-[#C8F000] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">WhatsApp</span>
                <button onClick={() => window.open('https://wa.me/5491123456789', '_blank')} className="w-12 h-12 bg-[#C8F000] rounded-full flex items-center justify-center text-black shadow-xl hover:scale-110 transition-all">
              ...
              <div className="relative group" style={isContactOpen ? { transform: 'rotateX(0deg) scale(1)', transition: 'transform 0.5s ease 0.2s' } : { transform: 'rotateX(90deg) scale(0)', transition: 'transform 0.5s ease 0.2s' }}>
                <span className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-full mr-2 bg-[#161616] text-[#C8F000] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Correo</span>
                <button onClick={() => window.open('mailto:contacto@bytescreativos.com')} className="w-12 h-12 bg-[#C8F000] rounded-full flex items-center justify-center text-black shadow-xl hover:scale-110 transition-all">
          ...
          <button onClick={() => setIsContactOpen(!isContactOpen)} className="contact-button w-16 h-16 bg-[#C8F000] rounded-full flex items-center justify-center text-black shadow-xl hover:scale-110 transition-all">
